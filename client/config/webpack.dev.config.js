...
const port = 3000;
let domain = 'http://youcai.abiz.com/';
if(process.env.BUILD_ENV === 'docDev'){
    domain = 'http://youcai.doc.abiz.com/';
}else if(process.env.BUILD_ENV === 'docProd'){
    domain = 'http://jxc.doc.abiz.com/';
}
