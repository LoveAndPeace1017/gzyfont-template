...
export default function withQuantityAmount(WrappedComponent) {
    return class WithQuantityAmount extends Base {
        ...
        calcTotalForOneRow = (quantity=0, amount=0) => {
            ...
            let {totalQuantity, totalAmount, aggregateAmount} = getTotalForm();
            ...
            let params = {totalQuantity, totalAmount, aggregateAmount};
            if(Base.isEmpty(quantity)) delete params.totalQuantity;
            if(Base.isEmpty(amount)) {
                delete params.totalAmount;
                delete params.aggregateAmount;
            }
            setTotalForm({totalQuantity, totalAmount, aggregateAmount});
        };
