...
@withGoodsPop
@withGoodsSuggest
export default class PpomTable extends Base {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        //处理字段配置
        const configFields = goodsTableConfig.get('materialData') && goodsTableConfig.get('materialData').toJS();
        // 物品自定义的columns
        ...
        let columns = [
            ...
            ...renderProdCustomFields(prodCustomFields),
            {
                ...
                render: (text, record) => {
                    return (
                        <Form.Item
                            name={[dataPrefix, record.key, 'warehouseName']}>
                            <SelectDeliveryAddress isWareHouses={true} showEdit={false} />
                        </Form.Item>
                    )
                }
            },
            {
                ...
                render: (text, record) => {
                    return (
                        <Form.Item
                            name={[dataPrefix, record.key, 'supplier']}>
                            <SelectSupplier maxLength={80}/>
                        </Form.Item>
                    )
                }
            },
