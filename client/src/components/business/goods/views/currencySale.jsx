...
import withCurrencyFooter from '../dependencies/withCurrencyFooter';
...
import withCurrencyQuantityAmount from '../dependencies/withCurrencyQuantityAmount';
...
export default class Sale extends Base {
    ...
    render() {
        ...
        let columns = [
            ...
            ...renderCustomFields(billCustomFields),
            {...deadlineDateColumn},
            {
                title: '备注',
                dataIndex: 'remarks',
