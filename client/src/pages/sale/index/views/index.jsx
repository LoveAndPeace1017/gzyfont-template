...
export default class Index extends ListPage {
    ...
    batchUpdateConfig = (callback)=>{
        ...
        let moduleType = {
            search:'saleOrder_search_list',
            table:'saleOrder_list'
        };
    ...
    deleteConfirm = (ids, cannotDelete, callback,source) => {
        ...
        _this.props.asyncBeforeDeleteSaleInfo(ids, (res)=>{
            Modal.confirm({
                title: intl.get("sale.index.index.warningTip"),
                content: res == 1?intl.get("sale.index.index.deleteConfirmContent_1") : intl.get("sale.index.index.deleteConfirmContent_2"),
                okButtonProps:{
                ...
                onOk() {
                    _this.props.asyncDeleteSaleInfo(ids, function(res) {
                        if (res.retCode === '0') {
                            ...
                            _this.props.asyncFetchSaleList(_this.state.condition, () => _this.checkRemove());
                            if (callback) {
                                callback();
                            }
                        }
    ...
    orderOpCallback = (result) => {
        if (result) {
            this.props.asyncFetchSaleList(this.state.condition, () => this.checkRemove());
        }
    };
            ...
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            url: '/sale/',
                            title: intl.get("sale.index.index.sale")
                        },
                        {
                            title: intl.get("sale.index.index.saleList")
                        }
                    ]}/>
                    ...
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            importModule={
                                {
                                    type:"sale",
                                    text: intl.get("sale.index.index.import"),
                                    module: "sale",
                            ...
                            searchPlaceHolder={intl.get("sale.index.index.searchPlaceHolder")}
                            refresh={this.refresh}
                        />
                        <CheckResult
                            module={"sale"}
