...
import {OldCustom as CustomField} from 'components/business/customField';
...
class OtherInfo extends Component {
    ...
    render() {
        ...
        let propertyValues = initBaseInfo && initBaseInfo.get('propertyValues') && initBaseInfo.get('propertyValues').toJS();
