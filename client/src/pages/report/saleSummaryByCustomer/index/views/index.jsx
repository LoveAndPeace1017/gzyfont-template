...
import {
    asyncFetchSaleSummaryByCustomerDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'saleSummaryByCustomer_list'
        };
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchSaleSummaryByCustomerDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterConfigList = [{
            label: "report.saleSummaryByCustomer.time",
            fieldName: 'time',
            ...
            showType: 'full',
            options: [
                {label: intl.get("report.saleSummaryByCustomer.collationOption1"), value: '0'},
                {label: intl.get("report.saleSummaryByCustomer.collationOption2"), value: '1'},
                {label: intl.get("report.saleSummaryByCustomer.collationOption3"), value: '2'}
            ]
        }];
        let tableConfigList = reportDetail.getIn(['data', 'tableConfigList']);
        tableConfigList = tableConfigList ? tableConfigList.toJS() : [];
        ...
        const filterDataSource = {
            ...
            groupComponents: [],
            suffixComponents: [
                <Button ga-data={'global-report-generate'} type="primary" loading={reportDetail && reportDetail.get('isFetching')} onClick={(reportDetail && !reportDetail.get('isFetching')) && this.generateReportForm}>{intl.get("report.saleSummaryByCustomer.getReport")}</Button>
            ]
        };
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get("report.saleSummaryByCustomer.title")
                        }
                    ]}/>
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="saleSummaryByCustomerReport"
                            onReset={()=> {
                    ...
                    <div className={"data-wrap cf"}>
                        <div className={"tb-wrap"}>
                            <ReportHd
                                sourceLabel={intl.get("report.saleSummaryByCustomer.source")}
                                sourceName={intl.get("report.saleSummaryByCustomer.sourceName")}
                            />
                            <ListTable
                                className={"report"}
                                columns={tempColumns}
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['saleSummaryByCustomerReportIndex', 'saleSummaryByCustomerDetail'])
});
