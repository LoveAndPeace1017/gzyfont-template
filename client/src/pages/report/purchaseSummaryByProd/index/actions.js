...
export const asyncFetchPurchaseSummaryByProdDetailReport=(params)=>({
    actionTypePrefix: constant.FETCH_PURCHASE_SUMMARY_BY_PROD,
    request: axios.post(`${BASE_URL}/report/purchaseSummaryByProd/detail`, params)
});
