...
import {
    asyncFetchPurchaseSummaryByProdDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'purchaseSummaryByProd_list'
        };
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchPurchaseSummaryByProdDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterConfigList = [{
            label: "report.purchaseSummaryByProd.time",
            fieldName: 'time',
            ...
            label: "report.purchaseSummaryByProd.catCode",
            fieldName: 'catCode',
            visibleFlag: true,
            cannotEdit: true,
            type: 'category'
        }, {
            label: "report.purchaseSummaryByProd.prodNo",
            fieldName: 'prodNo',
            visibleFlag: true,
            cannotEdit: true,
        ...
        const filterDataSource = {
            ...
            suffixComponents: [
                <Button ga-data={'global-report-generate'} type="primary" loading={reportDetail && reportDetail.get('isFetching')} onClick={(reportDetail && !reportDetail.get('isFetching')) && this.generateReportForm}>{intl.get('report.purchaseSummaryByProd.getReport')}</Button>
            ]
        };
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get('report.purchaseSummaryByProd.title')
                        }
                    ]}/>
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="purchaseSummaryByProdReport"
                            onReset={()=> {
                    ...
                    <div className={"data-wrap cf"}>
                        <div className={"tb-wrap"}>
                            <ReportHd
                                sourceLabel={intl.get('report.purchaseSummaryByProd.source')}
                                sourceName={intl.get('report.purchaseSummaryByProd.sourceName')}
                            />
                            <ListTable
                                className={"report"}
                                columns={tempColumns}
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['purchaseSummaryByProdReportIndex', 'purchaseSummaryByProdDetail'])
});
