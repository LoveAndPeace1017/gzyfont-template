...
export const asyncFetchSaleSummaryByProdDetailReport=(params)=>({
    actionTypePrefix: constant.FETCH_SALE_SUMMARY_BY_PROD,
    request: axios.post(`${BASE_URL}/report/saleSummaryByProd/detail`, params)
});
