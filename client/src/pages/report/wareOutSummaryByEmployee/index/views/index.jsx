...
import {
    asyncFetchWareOutSummaryByEmployeeDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchWareOutSummaryByEmployeeDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterConfigList = [{
            label: "node.report.wareOutSummaryByEmployee.time",
            fieldName: 'time',
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['wareOutSummaryByEmployeeReportIndex', 'wareOutSummaryByEmployeeDetail']),
