...
import {
    asyncFetchPurchaseRefundSummaryByProdDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'purchaseReturnStatistical_list'
        };
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchPurchaseRefundSummaryByProdDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterConfigList = [ {
            label: "report.purchaseRefundSummaryByProd.supplierName",
            fieldName: 'supplierName',
            visibleFlag: true,
            cannotEdit: true,
            type: 'supplier'
        },{
            label: "report.purchaseRefundSummaryByProd.time",
            fieldName: 'time',
            ...
            label: "report.purchaseRefundSummaryByProd.prodNo",
            fieldName: 'prodNo',
            visibleFlag: true,
            cannotEdit: true,
        ...
        const filterDataSource = {
            ...
            groupComponents: [],
            suffixComponents: [
                <Button ga-data={'global-report-generate'} type="primary" loading={reportDetail && reportDetail.get('isFetching')} onClick={(reportDetail && !reportDetail.get('isFetching')) && this.generateReportForm}>{intl.get("report.purchaseRefundSummaryByProd.getReport")}</Button>
            ]
        };
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get("report.purchaseRefundSummaryByProd.title")
                        }
                    ]}/>
                    <div className={cx("float-right")}>
                        <TableFieldConfigMenu filterList={filterConfigList} tableList={tableConfigList}
                            ...
                            //onFilterConfigChange={this.onFilterConfigChange}
                                              ...
                                              type="purchaseReturnStatistical"
                        />
                    </div>
                </div>
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="purchaseRefundSummaryByProdReport"
                            onReset={()=> {
                    ...
                    <div className={"data-wrap cf"}>
                        <div className={"tb-wrap"}>
                            <ReportHd
                                sourceLabel={intl.get("report.purchaseRefundSummaryByProd.source")}
                                sourceName={intl.get("report.purchaseRefundSummaryByProd.sourceName")}
                            />
                            <ListTable
                                className={"report"}
                                columns={tempColumns}
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['purchaseRefundSummaryByProdReportIndex', 'purchaseRefundReportSummaryByProdDetail'])
});
