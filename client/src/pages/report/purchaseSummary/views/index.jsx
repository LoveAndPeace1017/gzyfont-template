...
import {
    asyncFetchPurchaseSummaryDetailReport
} from '../actions'
...
import {reducer as purchaseSummaryReport} from "../index";
...
export class Index extends ListPage {
    ...
    generateReportForm = () => {
        ...
        if(param.endTime && param.startTime){
            console.log(param);
            this.props.asyncFetchPurchaseSummaryDetailReport(param || {}, (data) => {
                if (data.retCode != 0) {
                    ...
                    <div className={"tb-inner"}>
                      <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="purchaseSummaryReport"
                            onReset={()=> {
                        ...
                        <div className={"tb-wrap"}>
                            ...
                            <div>
                                <div className={cx("echarts-dom")}>
                                    ...
                                    <p className={cx("p-title")}>采购汇总图</p>
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['purchaseSummaryReport', 'purchaseSummaryDetail'])
});
