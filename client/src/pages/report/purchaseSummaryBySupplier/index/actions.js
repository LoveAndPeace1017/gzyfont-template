...
export const asyncFetchPurchaseSummaryBySupplierDetailReport=(params)=>({
    actionTypePrefix: constant.FETCH_PURCHASE_SUMMARY_BY_SUPPLIER,
    request: axios.post(`${BASE_URL}/report/purchaseSummaryBySupplier/detail`, params)
});
