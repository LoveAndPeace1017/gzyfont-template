...
import {
    asyncFetchInventoryPriceUntaxDetailReport,
    asyncFetchInventoryPriceUntaxDetailTaskReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
   ...
   batchUpdateConfig = (callback)=>{
       ...
       let moduleType = {
           table:'wareInventoryNotaxPriceByProd_list'
       };
    ...
    refreshReportForm = () =>{
        ...
        this.props.asyncFetchInventoryPriceUntaxDetailReport(param, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterDataSource = {
            ...
            suffixComponents: [
                ...
                <AsynExport condition={this.state.condition} clickFn={this.props.asyncFetchInventoryPriceUntaxDetailTaskReport}/>
            ]
        };
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get("home.menu.report.inOutPriceUntax")
                        }
                    ]}/>
                    <div className={cx("float-right")}>
                        <TableFieldConfigMenu filterList={filterConfigList} tableList={tableConfigList}
                            ...
                            //onFilterConfigChange={this.onFilterConfigChange}
                                              ...
                                              type="wareInventoryNotaxPriceByProd"
                        />
                    </div>
                </div>
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="inventoryPriceUntaxReport"
                            onReset={()=> {
...
const mapStateToProps = (state) => ({
    ...
    reportDetail: state.getIn(['inventoryPriceUntaxReportIndex', 'inventoryPriceUntaxDetail'])
});
