...
import {
    asyncFetchPurchaseDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'purchaseDetailByProd_list'
        };
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchPurchaseDetailReport(param, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        const filterConfigList = [{
            ...
            label: "report.purchase.catCode",
            fieldName: 'catCode',
            visibleFlag: true,
            cannotEdit: true,
            type: 'category'
        }, {
            label: "report.purchase.prodNo",
            fieldName: 'prodNo',
            visibleFlag: true,
            cannotEdit: true,
            ...
            label: "report.purchase.supplierName",
            ...
            label: "report.purchase.projName",
            fieldName: 'projName',
            visibleFlag: true,
            cannotEdit: true,
            type: 'project'
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get("report.purchase.title")
                        }
                    ]}/>
                        ...
                        <div className={"tb-wrap"}>
                            <PrintArea>
                                <ReportHd
                                    ...
                                    sourceName={intl.get("report.purchase.sourceName")}
                                />
                                <ListTable
                                    className={"report"}
                                    columns={tempColumns}
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['purchaseReportIndex', 'purchaseDetail'])
});
