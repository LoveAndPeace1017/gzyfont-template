...
import {
    asyncFetchSaleSummaryBySellerDetailReport,
    asyncUpdateConfig,
...
import {reducer as saleSummaryBySellerReportIndex} from "../index";
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'saleSummaryBySalesman_list'
        };
    ...
    refreshReportForm = () => {
        ...
        console.log(param);
        this.props.asyncFetchSaleSummaryBySellerDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        },
        {
            ...
            label: "report.saleSummaryByCustomer.collation",
            fieldName: 'orderFlag',
            visibleFlag: true,
            cannotEdit: true,
            type: 'select',
            showType: 'full',
            options: [
                {label: intl.get("report.saleSummaryByCustomer.collationOption4"), value: '0'},
                {label: intl.get("report.saleSummaryByCustomer.collationOption5"), value: '1'},
                {label: intl.get("report.saleSummaryByCustomer.collationOption6"), value: '2'}
            ]
        },{
                label: "report.saleSummaryByCustomer.collation1",
                fieldName: 'groupFlag',
                visibleFlag: true,
                cannotEdit: true,
                type: 'select',
                showType: 'full',
                options: [
                    {label: intl.get("report.saleSummaryByCustomer.collationOption7"), value: '1'}
                ]
            }];
        let tableConfigList = reportDetail.getIn(['data', 'tableConfigList']);
        tableConfigList = tableConfigList ? tableConfigList.toJS() : [];
        ...
        return (
            <React.Fragment>
                <div className="content-hd">
                    <Crumb data={[
                        {
                            title: intl.get("home.menu.report.saleSummaryBySeller")
                        }
                    ]}/>
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="saleSummaryBySellerReport"
                            onReset={()=> {
...
const mapStateToProps = (state) => ({
    reportDetail: state.getIn(['saleSummaryBySellerReportIndex', 'saleSummaryBySellerDetail'])
});
