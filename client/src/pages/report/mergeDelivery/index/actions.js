...
export const asyncFetchMergeDeliveryDetailReport=(params, callback)=>({
    actionTypePrefix: constant.FETCH_MERGE_DELIVERY,
    request: axios.post(`${BASE_URL}/report/mergeDelivery/detail`, params),
    callback
});
