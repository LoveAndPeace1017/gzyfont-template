...
import {
    asyncFetchMergeDeliveryDetailReport,
    asyncUpdateConfig,
...
export class Index extends ListPage {
    ...
    batchUpdateConfig = (callback) => {
        ...
        let moduleType = {
            table:'combineDeliveryNote_list'
        };
    ...
    refreshReportForm = () => {
        ...
        this.props.asyncFetchMergeDeliveryDetailReport(param || {}, (data) => {
            if (data.retCode != 0) {
    ...
    render() {
        ...
        let comName = reportDetail.getIn(['data', 'comName']);
                ...
                <div className="content-index-bd">
                    <div className="list-ope-wrap">
                        <ListOpeBar
                            ...
                            exportType="mergeDeliveryReport"
                            onReset={()=> {
                    ...
                    <div className={"data-wrap cf"}>
                        <div className={"tb-wrap"}>
                            <ReportHd
                                ...
                                sourceName={"出库单"}
                                deliveryInfo={{company:dataSource[0] && dataSource[0].customerName,address:dataSource[0] && dataSource[0].outAddress && (dataSource[0].outProvinceText+' '+dataSource[0].outCityText+' '+dataSource[0].outAddress),comName:comName}}
                            />
                            <ListTable
                                className={"report"}
                                columns={tempColumns}
...
const mapStateToProps = (state) => ({
    ...
    reportDetail: state.getIn(['mergeDeliveryReportIndex', 'mergeDeliveryDetail'])
});
