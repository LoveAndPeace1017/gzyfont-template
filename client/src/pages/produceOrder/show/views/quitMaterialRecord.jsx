...
export default class Index extends Component {
    ...
    onPageInputChange = (page, perPage) => {
        this.props.fetchData({activeKey: 'quitMaterialRecord', params: {perPage, page}});
    };
    onShowSizeChange = (current, perPage) => {
        this.props.fetchData({activeKey: 'quitMaterialRecord', params: {perPage, page: 1}});
    };
        ...
        let columns = [
            ...
            },
            {
                ...
                render: (prodAbstract, data) => (
                    <Dropdown
                        onVisibleChange={(visible) => this.props.loadWare(visible, data.billNo, 'quitMaterialRecord')}
                        overlay={() => (
