...
// 生产单列表
const produceOrderList = withBatchUpdateReducer(constant.TYPE, (
    state = fromJS({
        isFetching: false,
        data: []
    }),
    ...
    switch (action.type) {
        case constant.FETCH_PRODUCE_ORDER_CONFIG_SUCCESS:
            return state.set('config',action.data);
        case constant.FETCH_PRODUCE_ORDER_LIST_REQUEST:
            return state.set('isFetching', true);
        case constant.FETCH_PRODUCE_ORDER_LIST_SUCCESS:
            return state.set('isFetching', false)
                .set('data', action.data);
        case constant.FETCH_PRODUCE_ORDER_LIST_FAILURE:
            return state.set('isFetching', false);
